...
export const getUsersCurrentPage = (state: AppStateType) => state.users.currentPage
export const getUsersTotalUsersCount = (state: AppStateType) => state.users.totalUsersCount
